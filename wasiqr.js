		...
		try {
			...
			Qr_Code_By_Wasi_Tech.ev.on("connection.update", async (s) => {
				...
				if (connection == "open") {
				   ...
				   let WASI_MD_TEXT = `
*_Session Connected By lyrical Tech_*
*_Made With 🤍_*
______________________________________
╔════◇
║ *『AMAZING YOU'VE CHOSEN Lyrical MD』*
...
_Don't Forget To Give Star To My Repo_`
	 await Qr_Code_By_lyric_Tech.sendMessage(Qr_Code_By_Wasi_Tech.user.id,{text:WASI_MD_TEXT},{quoted:session})
